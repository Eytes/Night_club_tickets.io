...
if __name__ == '__main__':
    # TODO: привязать гугл таблицу с данными о купленных билетах
    # TODO: телеграмм бот для занесения в БД клиентов

    #  первокурсник | первак          200     (первак с репостом/историей)
    #  репост | история | нижка       300     (либо первак без репоста/истории, либо обычный с репостом/историей, либо с нижки)
    #  обычный                        400
    #  на входе | в последний день    500
    #  vip | VIP                      1000
    # add_buyer('первак', "Альяна Айиссии-Судина", "Мадлен", "+79054727090")
    # print(tickets_sold_amount())
    print(buyers_table())
    # come_out(3972605690)